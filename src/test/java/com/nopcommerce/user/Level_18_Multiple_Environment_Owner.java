...
public class Level_18_Multiple_Environment_Owner extends BaseTest {
	WebDriver driver;
	...
	public void beforeClass(@Optional("chrome") String browserName) throws BrowserNotSupport {
		String environmentName = System.getProperty("evnCommanline");
		ConfigFactory.setProperty("env", environmentName);
		environment = ConfigFactory.create(Environment.class);
		System.out.println(environment.getAppUserName());
		System.out.println(environment.getUserPasswork());
		System.out.println(environment.getDBUserName());
		System.out.println(environment.getDBPasswork());
