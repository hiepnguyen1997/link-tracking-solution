...
import pageUI.jQuery.uploadfile.BasePageUIJQueryUpload;
...
public class BasePage {
	...
	public void uploadMultipleFiles(WebDriver driver, String... fileNames) {
		...
		sendkeyToElement(driver, BasePageUIJQueryUpload.UPLOAD_FILE, fullFileName);
	}
	...
	public AdminLoginPageObject clickOnLougoutLinkAdminPage(WebDriver driver) {
		waitForElementVisible(driver, BasePageUINopCommerce.LOGOUT_LINK_ADMIN);
		clickToElement(driver, BasePageUINopCommerce.LOGOUT_LINK_ADMIN);
	...
	public UserHomePO openEndUserSite(WebDriver driver, String endUserURL) {
		...
		return PageGeneraterManagement.getUserHomePage(driver);
	}

	public pageObjects.wordpress.AdminDashboardPageObject openAdminSite(WebDriver driver, String adminURL) {
